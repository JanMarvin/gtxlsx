...
gtxlsx_theme <- function(ops) {
  ...
  list(
    ...
    pad_heading     = css_px(opt_chr(ops, "heading_padding", "4px")),
    pad_label       = css_px(opt_chr(ops, "column_labels_padding", "5px")),
    pad_group       = css_px(opt_chr(ops, "row_group_padding", "8px")),
    pad_row         = css_px(opt_chr(ops, "data_row_padding", "8px")),
    pad_summary     = css_px(opt_chr(ops, "summary_row_padding", "8px")),
    pad_gsummary    = css_px(opt_chr(ops, "grand_summary_row_padding", "8px")),
    pad_footnote    = css_px(opt_chr(ops, "footnotes_padding", "4px")),
    pad_source      = css_px(opt_chr(ops, "source_notes_padding", "4px")),
